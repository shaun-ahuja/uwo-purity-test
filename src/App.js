...
//             The Western Purity Test serves as a way for students to bond and track their experiences
...
//             <p className="description">
//               Shoutout to the University of Waterloo for the inspiration.
//             </p>
//           </p>
//           <p className="caution">
//             Caution: This is not a bucket list. You're cooked if you complete all of these items.
//           </p>
  ...
  return (
    <div className="purity-test results-page">
      ...
      <div className="results-content">
        <h2 className="result-score">Your Western Purity Score: {score}</h2>
